...
> 欢迎来到Gostar！在这里，一念分享各种各样的主题，包括加密货币、科学、文化、产品、大事件、人工智能、旅游、美食等等。我的目标是为读者提供有趣、有用、有启发性的内容，帮助他们了解世界和自我成长。
...
```yml
title: Gostar
subtitle: 发现新思想、新趋势和新技术
description: 欢迎来到Gostar！在这里，广超分享各种各样的主题，包括加密货币、科学、文化、产品、大事件、人工智能、旅游、美食等等。我的目标是为读者提供有趣、有用、有启发性的内容，帮助他们了解世界和自我成长。
keywords:
# 作者名称，会显示在侧边栏
author: YN
```
...
```sh
# 克隆仓库
$ git clone https://github.com/zizhuspot/www.gostar.top.git
# 安装依赖
$ yarn install
# 运行
$ yarn server
