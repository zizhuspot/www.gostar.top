...
在本文中,我们将为您提供一份使用Shoplaza步骤说明,无论您是要启动新业务还是要将商店迁移到新的电子商务平台。
...
为了方便网上交易,重要的是为客户设置支付解决方案。 要在Shoplaza上完成此操作,请转到“设置”>“支付”部分,您可以从可用的支付提供商中进行选择,并添加首选选项。 我们还建议使用Bogus网关测试您的支付流程。
